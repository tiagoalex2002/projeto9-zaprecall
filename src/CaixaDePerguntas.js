...
export default function Caixas(props){
    ...
    return(
        ...
        finalizado={props.finalizado} setFinalizado={props.setFinalizado} numero={i}/>
            ...
            <FinalIcon data-test={props.cores[i-1] === "#2FBE34" ? "zap-icon": (props.cores[i-1] === "#FF922E" ? "partial-btn" : "no-btn")}cores={props.cores} finalizado={props.finalizado} numero={i}><img src={props.cores[i-1] === "#2FBE34" ? certo : (props.cores[i-1] === "#FF922E" ? quase : erro)} alt="logo"/></FinalIcon>
